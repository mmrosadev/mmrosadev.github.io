export default {
    ...
    classesContent1: 'Are you thinking about taking your first steps in programming or making a career transition to software development?',
    classesContent2: 'My programming lessons are specially designed for beginners, covering theory and practice in a clear and engaging way so that you feel secure and confident at every stage of learning.',
    classesContentt3: 'Support is available for JavaScript, Python, Java, and C programming languages.',
    classesContent4: 'Here, we start from the basics, step by step. During the lessons, you will learn essential programming concepts and develop skills to solve computational problems and build projects.',
    classesAdvantages1: 'Exclusive time for theory and practice.',
    classesAdvantages2: 'Support materials and reinforcement exercises.',
    classesAdvantages3: 'Projects to get hands-on experience.',
    classesAdvantages4: 'Tools and best practices commonly used in the industry.',
