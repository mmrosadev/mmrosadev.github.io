export default {
    ...
    professionalSummaryContent: 'Five years of experience in web development. Solid knowledge of technologies such as JavaScript, TypeScript, React, Node.js, HTML, and CSS. Experience with microservices and microfrontend architectures, as well as mobile development using React Native. Additional skills: Next.js, Tailwind CSS, AWS (API Gateway, Lambda, S3), Firebase, Git, Jest, Linux, Java, Python, C, PHP, and familiarity with Scrum/Kanban methodologies. Intermediate English.',
    ...
    pe1Activity1: 'Developed systems based on microservices and microfrontends, using Docker and technologies such as JavaScript, Node.js, ReactJS, HTML, CSS, TypeScript, PHP, and Zend Framework.',
    ...
    pe3Activity1: 'Developed new features using React and TypeScript, ensuring dynamic and efficient user interfaces.',
