export default {
    ...
    professionalSummaryContent: 'Five years of experience in web development. Solid knowledge of technologies such as JavaScript, TypeScript, ReactJS, NodeJS, HTML, and CSS. Experience with microservices and microfrontend architectures, as well as mobile development using React Native. Additional skills: Next.js, Tailwind CSS, AWS (API Gateway, Lambda, S3), Firebase, Git, Jest, Linux, Java, Python, C, PHP, and familiarity with Scrum/Kanban methodologies. Intermediate English.',
    ...
    pe5Activity1: 'Development of web and mobile applications',
